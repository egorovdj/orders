...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Order>().HasData(
                new { Id = 1, ProviderId = 3, Number = "A-123", Date = DateTime.Parse("15.08.2022 0:00") },
                new { Id = 2, ProviderId = 1, Number = "S-123", Date = DateTime.Parse("15.08.2022 0:00") },
                new { Id = 3, ProviderId = 8, Number = "G-123", Date = DateTime.Parse("15.08.2022 0:00") },
                new { Id = 4, ProviderId = 9, Number = "O-123", Date = DateTime.Parse("15.08.2022 0:00") },
                new { Id = 5, ProviderId = 4, Number = "X-123", Date = DateTime.Parse("15.08.2022 0:00") },
                new { Id = 6, ProviderId = 3, Number = "A-124", Date = DateTime.Parse("15.08.2022 0:00") },
                new { Id = 7, ProviderId = 4, Number = "X-124", Date = DateTime.Parse("15.08.2022 0:00") },
                new { Id = 8, ProviderId = 19, Number = "R-124", Date = DateTime.Parse("15.08.2022 0:00") },
                new { Id = 9, ProviderId = 1, Number = "S-124", Date = DateTime.Parse("15.08.2022 0:00") },
                new { Id = 10, ProviderId = 4, Number = "X-125", Date = DateTime.Parse("15.08.2022 0:00") },
                new { Id = 11, ProviderId = 4, Number = "X-126", Date = DateTime.Parse("15.08.2022 0:00") },
                new { Id = 12, ProviderId = 1, Number = "S-125", Date = DateTime.Parse("15.08.2022 0:00") },
                new { Id = 13, ProviderId = 1, Number = "S-126", Date = DateTime.Parse("15.08.2022 0:00") },
                new { Id = 14, ProviderId = 5, Number = "OP-123", Date = DateTime.Parse("15.08.2022 0:00") },
                new { Id = 15, ProviderId = 10, Number = "H-123", Date = DateTime.Parse("15.08.2022 0:00") },
                new { Id = 16, ProviderId = 20, Number = "P-123", Date = DateTime.Parse("15.08.2022 0:00") },
                new { Id = 17, ProviderId = 4, Number = "X-127", Date = DateTime.Parse("15.08.2022 0:00") },
                new { Id = 18, ProviderId = 16, Number = "I-123", Date = DateTime.Parse("15.08.2022 0:00") },
                new { Id = 19, ProviderId = 19, Number = "R-123", Date = DateTime.Parse("15.08.2022 0:00") },
                new { Id = 20, ProviderId = 1, Number = "S-127", Date = DateTime.Parse("15.08.2022 0:00") }
                );
